...
function generatePassword() {
  ...
  while (passLength < 8 || passLength > 128) {
    alert("Only enter a number between 8 and 128 for the password length.");
    passLength = prompt("How many characters do you want your password be? (8-128 characters allowed)");
  }

  // Requirement Line 23 on "README.md"
  // WHEN prompted for the length of the password
  alert("Your password will have " + passLength + " characters long.");
  ...
  // Requirement Lines 29 and 28 on "README.md": 
